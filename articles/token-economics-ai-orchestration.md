...
Gemini はパラメーター数の違い、チューニングの違い、プロンプトの伝わり方の違いと、3層に分けて説明してくれました。ただし Gemini の「Ultra」は以前の命名規則で、現在は Pro が最上位です。現行モデルに合わせて整理するとこうなります。

| 役割 | Claude | Gemini | 人間で例えると |
|:---|:---|:---|:---|
| 軽量・高速 | Haiku | Flash | 作業の速い若手アシスタント |
| 実務の中核 | Sonnet | Pro | 現場のシニアエンジニア |
| 深い推論 | Opus | （Pro が兼任） | ベテランのアーキテクト |
