...
Gemini はパラメーター数の違い、チューニングの違い、プロンプトの伝わり方の違いと、3層に分けて説明してくれました。

| モデル | 職責 | 人間で例えると |
|:---|:---|:---|
| Haiku / Flash | 早く、指示通りに、定型フォーマットで返す | 作業の速い若手アシスタント |
| Sonnet / Pro | 速度と品質のバランスを取り、実務を回す | 現場のシニアエンジニア |
| Opus / Ultra | 時間をかけて複雑な文脈を読み解き、設計を出す | ベテランのアーキテクト |
