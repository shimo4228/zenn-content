...
type（tech / idea）にかかわらず、全記事を **だ/である調 × 発見調** で統一する。
...
> **変更履歴（2026-04-13）**: 旧ルールでは tech → ですます調 / idea → だ/である調だった。
> 著者の Voice Pattern が一貫してだ/である調であり、type による文体切り替えが摩擦を生んでいたため統一。
> 既存のですます調記事は遡及変更しない。
