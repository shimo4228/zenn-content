...
- **Length:** 50-60 characters optimal, 60 maximum
...
- **Avoid clickbait:** No "必見！", "超簡単！", "たった3分で"
- **Use natural Japanese:** Avoid overly formal or unnatural phrasing

**Good examples:**
- "TDD で作る pdf2anki の品質保証パイプライン"
- "Claude Code の半自動開発フローで生産性を 3 倍にする"
- "日本語トークン化の落とし穴と CJK バイグラム実装"

**Bad examples:**
- "AI で Anki カード作成" (too vague)
- "必見！Claude を使った最強の自動化ツール" (clickbait)
- "PDF から Anki カードを自動生成するツールを作った話" (too long, 70+ chars)
