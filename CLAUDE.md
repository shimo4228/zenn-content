...
Human-primary prose has one global entrypoint: `~/.claude/skills/writing-ecosystem/SKILL.md`.
...
Drafting stays in the orchestrator. Review and acceptance follow global `writing-ecosystem` plus the local
channel contract; no project-local writing orchestrator, editorial-judgment skill, or quality judge exists.
